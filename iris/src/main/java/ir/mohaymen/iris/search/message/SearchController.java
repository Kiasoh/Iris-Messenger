...
public class SearchController {
    ...
    public ResponseEntity<List<String>> indexListOfMessages(@RequestBody List<SearchMessageDto> messages) {
        List<String> responses = searchMessageService.bulkIndex(messages);
    ...
    // @PostMapping("")
    // public ResponseEntity<List<SearchMessageDto>>
    // getMatchedMessages(@PathVariable String text){
    // List<SearchMessageDto> messages =
    // searchMessageService.createMessageIndexBulk()
